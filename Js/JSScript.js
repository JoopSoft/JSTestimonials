...
(function ($, Sys) {
    ...
    $(document).ready(function () {
        ...
        $('.JSTestimonials .link-5-star')
            .prepend(function () {
                var $stars = '';
                for (var i = 0; i < 5; i++) $stars += $lnkStar;
                return $stars + ' ';
            });
        $('.JSTestimonials .link-4-star')
            .prepend(function () {
                var $stars = '';
                for (var i = 0; i < 4; i++) $stars += $lnkStar;
                return $stars + ' ';
            });
        $('.JSTestimonials .link-3-star')
            .prepend(function () {
                var $stars = '';
                for (var i = 0; i < 3; i++) $stars += $lnkStar;
                return $stars + ' ';
            });
        $('.JSTestimonials .link-2-star')
            .prepend(function () {
                var $stars = '';
                for (var i = 0; i < 2; i++) $stars += $lnkStar;
                return $stars + ' ';
            });
        $('.JSTestimonials .link-1-star')
            .prepend(function () {
                var $stars = '';
        ...
        $('.JSTestimonials .link-5-star.no-txt')
            .html(function () {
                var $stars = '';
                for (var i = 0; i < 5; i++) $stars += $lnkStar;
                return $stars;
            });
        $('.JSTestimonials .link-4-star.no-txt')
            .html(function () {
                var $stars = '';
                for (var i = 0; i < 4; i++) $stars += $lnkStar;
                return $stars;
            });
        $('.JSTestimonials .link-3-star.no-txt')
            .html(function () {
                var $stars = '';
                for (var i = 0; i < 3; i++) $stars += $lnkStar;
                return $stars;
            });
        $('.JSTestimonials .link-2-star.no-txt')
            .html(function () {
                var $stars = '';
                for (var i = 0; i < 2; i++) $stars += $lnkStar;
                return $stars;
            });
        $('.JSTestimonials .link-1-star.no-txt')
            .html(function () {
                var $stars = '';
                for (var i = 0; i < 1; i++) $stars += $lnkStar;
                return $stars;
        ...
        $('.JSTestimonials .hidder input:checkbox')
            .each(function () {
                var $this = $(this),
        ...
        $('.JSTestimonials .unhidder input:checkbox')
            .each(function () {
                var $this = $(this),
                    $target = $this.parent().data('target');
        ...
        $('.JSTestimonials .check-equal-two-options')
            .each(function () {
        ...
        $('.JSTestimonials .uncheck-equal-two-options')
            .each(function () {
                if ($(this).val() !== $(this).data('equal') || $(this).val() !== $(this).data('equal-two')) $($(this).data('target')).show();
                else $($(this).data('target')).hide();
            })
        ...
        $('.JSTestimonials .hidder-radio-equal input:radio')
            .each(function () {
                if ($(this).is(':checked')) {
        ...
        $('.JSTestimonials .hidder-radio-option input:radio')
            .each(function () {
