...
namespace JS.Modules.JSTestimonials
{
    ...
    /// 
    /// Because the control inherits from JSTestimonialsSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : JSTestimonialsModuleSettingsBase
    {
        ...
        public override void LoadSettings()
        {
            try
            {
                if (Page.IsPostBack == false)
                {
                    ...
                    btnAddEntry.NavigateUrl = EditUrl();
                }
            }
